...
[*.{blockshader,c,c++,c++m,cc,ccm,cginc,compute,cp,cpp,cppm,cql,cu,cuh,cxx,cxxm,fx,fxh,h,h++,hh,hlsl,hlsli,hlslinc,hp,hpp,hxx,icc,inc,inl,ino,ipp,ixx,mpp,mq4,mq5,mqh,mxx,shaderFoundry,sql,tcc,tpp,urtshader,usf,ush}]
indent_style = tab
indent_size = tab
tab_width = 4
...
[*.{appxmanifest,axml,config,csproj,dbml,discomap,dtd,jsproj,lsproj,njsproj,nuspec,proj,props,resw,resx,StyleCop,targets,tasks,vbproj,xml,xsd}]
indent_style = space
indent_size = 2
tab_width = 2
...
resharper_align_altered_items = true
resharper_align_altering_instructions = true
resharper_align_asc_desc = false
resharper_align_equals = true
resharper_align_first_arg_by_paren = false
resharper_align_first_word_of_clause = to_left
resharper_align_joined_tables = false
resharper_align_line_comments_at_right_of_elements = true
...
resharper_align_multi_row_values = false
resharper_align_multi_row_values_break_threshold = seven
resharper_align_multi_row_values_minimal_increase_threshold = three
resharper_align_multi_row_values_percentile = auto
resharper_align_multi_row_values_with_insert = false
resharper_align_options = true
resharper_align_section_elements = true
resharper_align_table_aliases = false
...
resharper_alter_table_align_defaults = true
resharper_alter_table_align_nullabilities = true
resharper_alter_table_align_types = true
...
resharper_binary_expression_align_operands_in_binary_expressions = true
resharper_binary_expression_space_within_parenthesized_sub_expressions = false
resharper_binary_expression_use_spaces_around_operators = yes
...
resharper_case_align_else_under_then_when_then_aligned = false
resharper_case_align_end = do_not_change
resharper_case_align_then = false
resharper_case_collapse_short_clause = true
resharper_case_indent_when_if_wrapped = true
resharper_case_keep_new_line_after_then_else = false
resharper_case_wrap_then = false
resharper_case_wrap_when = true
resharper_collapse_short_multi_row_values = false
resharper_collapse_short_statement = subqueries_only
resharper_commands_follow_by_blank_lines = do_not_change
resharper_configure_await_analysis_mode = disabled
resharper_constructor_or_destructor_body = block_body
resharper_continuation_indent_size = 8
resharper_continuous_indent_multiplier = 1
resharper_continuous_line_indent = single
resharper_cortege_add_space_before_opening_parenthesis = true
resharper_cortege_place_comma_to_begin = false
resharper_cortege_space_after_comma = true
resharper_cortege_space_before_comma = false
resharper_cortege_space_within_parenthesis = false
...
resharper_create_schema_indent_content = true
resharper_create_schema_maximum_blank_lines_between_declarations = 1
resharper_create_schema_minimum_blank_lines_between_declarations = 1
resharper_create_table_collapse_when_short = false
resharper_create_table_place_closing_parenthesis = under_opening
resharper_create_table_place_elements = wrapped_indented
resharper_create_table_place_opening_parenthesis = aligned
...
resharper_declared_variables_align_assignments = true
resharper_declared_variables_align_expressions = false
resharper_declared_variables_align_types = true
resharper_declared_variables_wrap_section = true
...
resharper_from_clause_place_comma = as_in_common
resharper_from_clause_place_elements_on = as_in_common
resharper_from_clause_wrap_elements = chop
resharper_function_call_space_after_comma = true
resharper_function_call_space_before_comma = false
resharper_function_call_space_within_parentheses = false
...
resharper_group_by_clause_place_comma = as_in_common
resharper_group_by_clause_place_elements_on = as_in_common
resharper_group_by_clause_wrap_elements = wrap_if_long
...
resharper_if_then_collapse_when_short = true
resharper_if_then_wrap_inner_code = true
...
resharper_indent_altered_items = true
resharper_indent_altering_instructions = true
...
resharper_indent_end_if = false
resharper_indent_end_loop = false
...
resharper_indent_join = true
resharper_indent_loop = true
...
resharper_indent_then_and_else = false
...
resharper_insert_statement_place_closing_parenthesis = at_the_end
resharper_insert_statement_place_comma = as_in_common
resharper_insert_statement_place_opening_parenthesis = on_the_same_line
resharper_insert_statement_spaces_within_parentheses = false
...
resharper_keep_items_on_one_line_if_less_or_equal = 7
resharper_keep_section_elements_under_section_header = true
...
resharper_loop_collapse_when_short = false
...
resharper_new_line_after_all_distinct = false
...
resharper_place_clause_elements_on = same_line
resharper_place_columns_or_values = same_line_aligned
resharper_place_comma = auto
...
resharper_place_into_clause_elements_on = as_in_common
resharper_place_into_on_the_new_line = do_not_change
resharper_place_join_in_join_only_queries_under = table
...
resharper_place_on_and_using_under = table
...
resharper_place_subquery = do_not_change
resharper_place_top_level_and_or_under = to_begin
resharper_place_type_attribute_on_same_line = false
resharper_place_type_constraints_on_same_line = true
resharper_place_values_clause_elements_on = as_in_common
...
resharper_routine_arguments_align_types = false
resharper_routine_arguments_place_closing_parenthesis = do_not_change
resharper_routine_arguments_place_comma = auto
resharper_routine_arguments_place_elements = do_not_change
resharper_routine_arguments_place_opening_parenthesis = on_the_same_line
resharper_routine_arguments_spaces_within_parentheses = false
resharper_routine_arguments_wrap_elements = wrap_if_long
resharper_routine_statement_wrap_as = false
resharper_routine_statement_wrap_before_closing_dollar_quote = true
resharper_routine_statement_wrap_opening_dollar_quote = true
resharper_routine_statement_wrap_options_after_closing_dollar_quote = false
resharper_routine_statement_wrap_the_content_after_opening_dollar_quote = true
resharper_select_clause_align_as = true
resharper_select_clause_place_comma = as_in_common
resharper_select_clause_place_elements_on = as_in_common
resharper_select_clause_use_as = do_not_change
resharper_select_clause_wrap_elements = chop
...
resharper_sql_insert_final_newline = false
resharper_sql_max_line_length = 120
resharper_sql_wrap_lines = true
...
resharper_subquery_place_closing_parenthesis = do_not_change
resharper_subquery_place_opening_parenthesis = do_not_change
resharper_subquery_spaces_within_parentheses = false
resharper_subquery_space_after_keyword = do_not_change
...
resharper_treat_asterisk_as_regular = false
resharper_treat_case_statement_with_break_as_simple = true
resharper_update_statement_place_comma = as_in_common
resharper_update_statement_place_elements_on = as_in_common
resharper_update_statement_wrap_elements = chop
...
resharper_views_indent_query = false
resharper_views_wrap_as = false
resharper_views_wrap_the_beginning_of_the_query = true
resharper_where_clause_place_elements_on = as_in_common
resharper_where_clause_wrap_elements = chop
resharper_with_clause_align_as = false
resharper_with_clause_place_comma = as_in_common
resharper_with_clause_place_elements_on = as_in_common
resharper_with_clause_wrap_elements = chop
...
resharper_wrap_altered_items = do_not_change
resharper_wrap_altering_instructions = yes
...
resharper_wrap_cascade_and_deferrability = false
...
resharper_wrap_columns_or_values = wrap_if_long
resharper_wrap_command_ending_semicolon = do_not_change
resharper_wrap_comments = false
resharper_wrap_constraint = true
resharper_wrap_ctor_initializer_style = wrap_if_long
resharper_wrap_else = true
resharper_wrap_enumeration_style = chop_if_long
resharper_wrap_enum_declaration = chop_always
resharper_wrap_every_statement = false
resharper_wrap_extends_list_style = wrap_if_long
resharper_wrap_first_join = true
resharper_wrap_first_option = false
resharper_wrap_for_stmt_header_style = chop_if_long
resharper_wrap_key_check = false
resharper_wrap_list_pattern = wrap_if_long
resharper_wrap_loop = true
...
resharper_wrap_next_join = true
resharper_wrap_next_option = true
resharper_wrap_object_and_collection_initializer_style = chop_if_long
resharper_wrap_on_and_using = false
...
resharper_wrap_references = false
resharper_wrap_switch_expression = chop_always
resharper_wrap_ternary_expr_style = chop_if_long
resharper_wrap_then = false
resharper_wrap_variables = do_not_change
...
resharper_ms_builtin_inspection_highlighting = warning
resharper_ms_order_by_inspection_highlighting = error
...
resharper_mysql_load_data_path_inspection_highlighting = warning
resharper_mysql_parsing_inspection_highlighting = warning
resharper_mysql_space_after_function_name_inspection_highlighting = error
...
resharper_ora_missing_body_inspection_highlighting = warning
resharper_ora_overload_inspection_highlighting = warning
resharper_ora_unmatched_forward_declaration_inspection_highlighting = error
...
resharper_pg_select_from_procedure_inspection_highlighting = warning
...
resharper_razor_assembly_not_resolved_highlighting = error
...
resharper_sql_add_not_null_column_inspection_highlighting = warning
resharper_sql_aggregates_inspection_highlighting = warning
resharper_sql_ambiguous_column_inspection_highlighting = warning
resharper_sql_auto_increment_duplicate_inspection_highlighting = warning
resharper_sql_call_notation_inspection_highlighting = error
resharper_sql_case_vs_coalesce_inspection_highlighting = warning
resharper_sql_case_vs_if_inspection_highlighting = warning
resharper_sql_check_using_columns_inspection_highlighting = warning
resharper_sql_constant_expression_inspection_highlighting = warning
resharper_sql_deprecate_type_inspection_highlighting = warning
resharper_sql_derived_table_alias_inspection_highlighting = warning
resharper_sql_drop_indexed_column_inspection_highlighting = warning
resharper_sql_dt_inspection_highlighting = warning
resharper_sql_duplicate_column_inspection_highlighting = warning
resharper_sql_goto_inspection_highlighting = none
resharper_sql_identifier_inspection_highlighting = warning
resharper_sql_illegal_cursor_state_inspection_highlighting = warning
resharper_sql_insert_into_generated_column_inspection_highlighting = warning
resharper_sql_insert_null_into_not_null_inspection_highlighting = warning
resharper_sql_insert_values_inspection_highlighting = warning
resharper_sql_join_count_inspection_highlighting = none
resharper_sql_join_without_on_inspection_highlighting = warning
resharper_sql_misleading_reference_inspection_highlighting = warning
resharper_sql_missing_column_aliases_inspection_highlighting = none
resharper_sql_missing_return_inspection_highlighting = error
resharper_sql_multiple_limit_clauses_inspection_highlighting = warning
resharper_sql_named_arguments_inspection_highlighting = none
resharper_sql_redundant_alias_inspection_highlighting = warning
resharper_sql_redundant_code_in_coalesce_inspection_highlighting = warning
resharper_sql_redundant_else_null_inspection_highlighting = warning
resharper_sql_redundant_limit_inspection_highlighting = warning
resharper_sql_redundant_ordering_direction_inspection_highlighting = warning
resharper_sql_shadowing_alias_inspection_highlighting = warning
resharper_sql_should_be_in_group_by_inspection_highlighting = warning
resharper_sql_side_effects_inspection_highlighting = warning
resharper_sql_signature_inspection_highlighting = warning
resharper_sql_single_session_mode_inspection_highlighting = warning
resharper_sql_string_length_exceeded_inspection_highlighting = warning
resharper_sql_transaction_statement_in_trigger_inspection_highlighting = warning
resharper_sql_trigger_transition_inspection_highlighting = warning
resharper_sql_type_inspection_highlighting = warning
resharper_sql_unicode_string_literal_inspection_highlighting = warning
resharper_sql_unreachable_code_inspection_highlighting = warning
resharper_sql_unused_cte_inspection_highlighting = warning
resharper_sql_unused_subquery_item_inspection_highlighting = warning
resharper_sql_unused_variable_inspection_highlighting = warning
resharper_sql_without_where_inspection_highlighting = warning
